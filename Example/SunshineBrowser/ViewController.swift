...
class ViewController: UIViewController {
	...
	override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
		...
		let mix = BrowserMixPreviewController.show(in: self, models: models, selectedIndex: 2, originalFrame: CGRect.init(x: 0, y: 300, width: 60, height: 80))
		present(mix, animated: true, completion: nil)
		//        let images = [
		//            UIImage(named: "p1")!,
		//            UIImage(named: "p2")!,
		//
		...
		//        ]
		//
		//        let singlePreviewController = BrowserPhotoPreviewController.show(in: self, images: images, selectedIndex: 0, originalFrame: nil)
		//        present(singlePreviewController, animated: true) {
		//            print("present singlePreviewController success")
		//        }
	}
